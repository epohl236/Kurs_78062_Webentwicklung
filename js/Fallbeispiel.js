 ...
 */
function showSearchResults (aAirports, parent)
{
    // Create a list of search results as a table.
...
function handleInput (ev)
{
    ...
    if (searchString.length > 0)
    {
        ...
        if (aSearchResults.length > 0)
            showSearchResults (aSearchResults, divList);
    }
}
 ...
 */
function handleSearchListClick (ev)
{
    //console.log (ev);
 ...
 */
function installInputHandler (id)
{
 ...
 */
function installSearchClickHandler (id)
{
    ...
    divList.addEventListener ("click", handleSearchListClick);
}
...
{
    installInputHandler ("#departure_from");
    installInputHandler ("#departure_to");
    installInputHandler ("#arrival_from");
    installInputHandler ("#arrival_to");
    installSearchClickHandler ("#departure_from_list");
    installSearchClickHandler ("#departure_to_list");
    installSearchClickHandler ("#arrival_from_list");
    installSearchClickHandler ("#arrival_to_list");
}
